# ✨ Identidade Visual: fotonPDF

A identidade visual do **fotonPDF** é construída sobre o conceito de **Clareza através da Luz**. O nome evoca a partícula elementar da luz (fóton), sugerindo que o software não apenas processa arquivos, mas ilumina a informação, tornando-a rápida e compreensível.

---

## 🎨 Paleta de Cores (The Light Spectrum)

Buscamos um equilíbrio entre a seriedade de ferramentas profissionais e a energia da luz.

| Cor | Hex | Conceito | Uso |
| --- | --- | --- | --- |
| **Solar Gold** | `#FFC107` | A energia do fóton, calor e destaque. | Logo, Botões Primários, Destaques. |
| **Deep Space** | `#0F172A` | O vácuo onde a luz viaja. Elegância e contraste. | Backgrounds (Dark Mode), Textos Principais. |
| **Photon Blue** | `#38BDF8` | A velocidade e a tecnologia. | Ícones secundários, Links, Hover. |
| **Paper White** | `#F8FAFC` | A clareza do documento final. | Backgrounds Light mode, Texto em fundo escuro. |

---

## 📐 Tipografia

* **Principal**: `Outfit` ou `Inter` (Sans-serif moderna).
  * *Por que?* Geometria limpa que transmite precisão e modernidade.
* **Mono**: `JetBrains Mono` (para elementos técnicos/CLI).
